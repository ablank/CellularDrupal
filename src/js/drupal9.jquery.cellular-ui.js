(function ($, Drupal, once) {
  ...
  let content = window.getComputedStyle(document.querySelector('body'), ':before').getPropertyValue('content');
          var win = {};
        /*
   if (content) {
  ...
  let o = jQuery.extend({
      ...
      let $t = jQuery(this);
              var hold = (holder = $t.attr("placeholder"));
            $t.on("focus", function () {
              holder = "";
      ...
      `${o.cclass  }-inactive`
        ...
        fn.listen = function ($obj, state) {
          ...
          jQuery(document).on("keyup", function (e) {
            // ENTER opens menu.
            if (
              jQuery("." + o.cclass + "-trigger").is(":focus") &&
              e.which === 13
            ) {
              e.preventDefault();
    ...
    let controls = $obj.siblings('.controls');
            var wrap = $obj.parent();
            var eX = null;
            var eY = null;
        ...
        fn.style = function ($obj, state) {
          ...
          li.prop("tabindex", "-1")
            ...
            .each(function () {
              ...
              if (o.background) {
                let background = $t.find(o.background);
          ...
          $obj.once("jSocial", function () {
              ...
              var sWrap = $('<div class="jSocial-share" />'),
                ...
                sharelinks = {
                  ...
                  linkedin: {
                    title: "LinkedIn",
                    url:
                      "http://linkedin.com/shareArticle?url=" +
                      page +
                      "&title=" +
                      doctitle,
                  },
            ...
            if (Object.keys(o.follow) !== "undefined") {
              ...
              /*
                ...
                fWrap.append(
                  '<span class="title">' + o.followtitle + "</span>"
                );
  ...
  let o = jQuery.extend({
    ...
    let content = li.find('.content');
        ...
        fn.init = function () {
          var $obj = jQuery(this),
            tab = $obj.find("> li"),
            wrap = jQuery("<div/>").classify([o.orient, o.cclass + "-wrap"]),
